...
Components must include unit tests via [Jest](https://github.com/facebook/jest) tests and functional tests via [Webdriver.io](http://webdriver.io/) and follow our [testing conventions](/about/terra-ui/contributing/conventions#testing-conventions) for Terra.
