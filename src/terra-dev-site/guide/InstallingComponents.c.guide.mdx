...
The first Terra UI packages that you will want to install are [terra-base](/components/terra-base/base/base) and [terra-aggregate-translations](https://github.com/cerner/terra-aggregate-translations).
...
These are required to help set up [the needed internationalization config](/guides/terra-ui/internationalization/internationalization-intro) used with Terra UI.
...
- [terra-base](/components/terra-base/base/base) - The foundational Terra component required with the usage of any Terra UI component that sets minimal global styles and provides internationalization support for an application.
