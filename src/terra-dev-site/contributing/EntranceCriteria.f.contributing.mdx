...
Terra is open source. Thus, components should not leak or depend on internal Cerner intellectual property. Specific examples of things to look out for that will not be allowed in Terra are:

* Service calls
* Internal components references
* Holistic clinical components
