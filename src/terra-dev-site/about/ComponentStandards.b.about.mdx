...
* Not use hover events without a alternative method of accessing the same information
...
Components follow [sass-guidelines](https://sass-guidelin.es/), provide Style encapsulation via [CSS Modules](https://github.com/css-modules/css-modules), adhere to our [stylelint config](https://github.com/cerner/stylelint-config-terra), and follow our [CSS conventions](/about/terra-ui/contributing/conventions#css-conventions) for Terra UI.

## JavaScript

Components follow [Airbnb javascript style guide](https://github.com/airbnb/javascript), adhere to our [eslint config](https://github.com/cerner/eslint-config-terra) and our [JS conventions](/about/terra-ui/contributing/conventions#javascript-conventions) for Terra UI.

## Testing

Components must include unit tests via [Jest](https://github.com/facebook/jest) tests and functional tests via [Webdriver.io](http://webdriver.io/) and follow our [testing conventions](/about/terra-ui/contributing/conventions#testing-conventions) for Terra UI.
