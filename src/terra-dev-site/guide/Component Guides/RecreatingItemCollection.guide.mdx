...
In the following examples we create 2 different displays. A [terra-list](/components/terra-list/list/list) display is used when browser size is below 'medium'. The other display is a [terra-table](/components/terra-table/table/table).
