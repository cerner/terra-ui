...
[Terra Functional Testing](/dev_tools/cerner-terra-toolkit-docs/terra-functional-testing/about) uses [Docker](https://www.docker.com/) to setup, run, and tear down selenium to ensure a consistent testing environment locally and in continuous integration build systems. To use Terra Functional Testing for webdriver testing, you must install docker on your machine.
