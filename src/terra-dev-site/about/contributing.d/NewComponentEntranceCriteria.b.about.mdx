...
Terra requires the approval of Cerner's Terra UX design team for both component enhancements and new components added to our library. This team ensures general UX consistency of the Terra component library and compliance with Cerner design standards. To start the contribution process, be sure to log an issue for the Terra UX team to review.
