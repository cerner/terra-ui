...
- Changes to high impact, complex components

### Tech design

The first step is to log a github issue that includes a brief tech design outlining proposed prop APIs, responsive and accessibly considerations. It is crucial that contributors remain in sync with terra team standards and expectations to avoid expensive rework late in the contribution.

### Contributor Expectations

To ensure there are no surprises on PRs and the resulting component, contributors are expected to have regular syncs with the allocated Terra UX and Engineers. This can include periodic meetings and/or attending scrum.
...
### Allocated Terra UX Support and Design

A Terra UX designer must be involved from the beginning of the contribution. It is expected that Terra UX designer will provide guidance on:
