...
Terra is divided into a several projects:
...
- [terra-toolkit](https://github.com/cerner/terra-toolkit-boneyard) - A set of tools providing configuration, as well as helper functions for testing.
