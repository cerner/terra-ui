...
For Terra, [we default the CSS Modules scope to be global](https://github.com/cerner/terra-toolkit-boneyard/blob/master/config/webpack/webpack.config.js#L64).
