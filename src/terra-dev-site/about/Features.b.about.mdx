import StaticAssetsIcon from '../icon/StaticAssetsIcon';
...
_\* To support legacy browsers, additional configuration is required. [View the webpack documentation for Terra which covers additional config required for legacy browsers](/dev_environment/terra-ui/webpack)._
