...
Translations must be included for each locale the app intends to support. At a minimum, apps must include `en` translations as it is intended to be the fallback locale for terra-application.
