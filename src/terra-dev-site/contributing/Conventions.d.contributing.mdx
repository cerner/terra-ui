...
We use a concept called [CSS Modules](https://github.com/css-modules/css-modules) when creating the styles for the Terra UI components. A CSS Module is a CSS file, SCSS file in our case, in which all class names and animation names are scoped locally by default.
