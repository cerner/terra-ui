...
const mockData = [
  {
    ...
    primaryIndex: 1,
    cells: [
      { key: 'startAccessory', children: <IconAlert />, attrs: { className: cx('content-accessory', 'content-accessory-align-center')} },
      ...
      { key: 'endAccessory', children: <IconInformation />, attrs: { className: cx('content-accessory', 'content-accessory-align-center', 'content-end-accessory')} },
    ],
  },
  {
    key: 'row-1',
